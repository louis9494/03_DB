 ...
 *
 * * USER_TABLES : 계정이 소유한 객체 등에 관한 정보를 조회 할 수 있는 딕셔너리 뷰중 하나
...
-- 삽입/수정 시 NULL 값을 허용하지 않도록 컬럼레벨에서 제한을 해야한다
...
-- ORA-01400: NULL을 ("KH_OSH"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: 
-- ORA-00001: 무결성 제약 조건(KH_OSH.USER_ID_U)에 위배됩니다
...
-- NOT NULL + UNIQUE 제약조건을 합쳐놓은 것과 같음 -> 중복되지 않는 값이 필수로 존재해야함.

-- 한 테이블당 한 개만 설정할 수 있음
-- 컬럼레벨, 테이블레벨 둘 다 설정 가능
-- 한 개 컬럼에 설정할 수 있고, 여러개의 칼럼을 묶어서 설정할 수 있음(== PRIMARY 복합키)
...
INSERT INTO USER_USED_PK
VALUES (1, 'USER02', 'PASS02', '이순신', '남자', '010-2222-2222', 'hong123@kh.or.kr');
-- 기본키 중복 오류!

INSERT INTO USER_USED_PK
VALUES (NULL, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1212', 'hong123@kh.or.kr');
-- 기본키 NULL 이므로 오류!
--SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_OSH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK
VALUES (2, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1212', 'hong123@kh.or.kr');
...
INSERT INTO USER_USED_PK2
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'lee123@kh.or.kr');
--SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_OSH.PK_USERNO_USERID)에 위배됩니다
-- user_no, user_id 둘 다 중복되었을 때만 제약조건 위배 에러 발생!

INSERT INTO USER_USED_PK2
VALUES (NULL, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'lee123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_OSH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2
VALUES (3, NULL, 'PASS01', '홍길동', '남자', '010-1234-5678', 'lee123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_OSH"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다

--> 둘 중 하나라도 NULL 이면 위배!

DELETE FROM USER_USED_PK2 WHERE EMAIL = 'lee123@kh.or.kr';
ROLLBACK;
---------------------------------------------------------------------------------------------------
...
CREATE TABLE USER_GRADE(
	GRADE_CODE NUMBER PRIMARY KEY, -- 등급 별 고유 번호
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'lee123@kh.or.kr', 10);
-- USER_GRADE (부모테이블/참조테이블)에 10이라는 GRADE_CODE 가 존재하므로 가능
...
INSERT INTO USER_USED_FK
VALUES (3, 'USER03', 'PASS03', '유관순', '여자', '010-3333-1111', 'you123@kh.or.kr', 30);
-- USER_GRADE (부모테이블/참조테이블)에 30이라는 GRADE_CODE 가 존재하므로 가능
...
-- ORA-02291: 무결성 제약조건(KH_OSH.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- ORA-02292: 무결성 제약조건(KH_OSH.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
SELECT * FROM USER_GRADE3; -- 부모에서 10 삭제
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_OSH.GENDER_CHECK)이 위배되었습니다
